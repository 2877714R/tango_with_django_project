...
def populate():
    python_pages = [ {'title': 'Official Python Tutorial', 
                    ...
                    {'title':'How to Think like a Computer Scientist',
                        'url':'http://www.greenteapress.com/thinkpython/', 'views' : 67}, 
                    {'title':'Learn Python in 10 Minutes', 
                        'url':'http://www.korokithakis.net/tutorials/python/','views' : 12}, ]
    
    django_pages = [{'title': 'Official Django Tutorial',
     'url': 'https://docs.djangoproject.com/en/2.1/intro/tutorial01/', 'views' : 89},
    {'title': 'Django Rocks',
     'url': 'http://www.djangorocks.com/', 'views' : 45},
    {'title': 'How to Tango with Django',
     'url': 'http://www.tangowithdjango.com/', 'views' : 56}
    ]
